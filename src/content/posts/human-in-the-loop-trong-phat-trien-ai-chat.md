...
Vì vậy ngay từ 6 tháng trước là đội mình đã chọn kiến trúc sản phẩm sao cho con người và AI sẽ cùng làm việc với nhau một cách chặt chẽ. AI liên tục học hỏi từ con người để làm tốt hơn, được giao nhiều phần việc hơn. Như quá trình học tập và phát triển của một nhân sự thực thụ. Mỗi lần agent fail không phải là một lỗi cần che đi, mà là một tín hiệu để đội vận hành biết cần viết lại policy nào, tách lại luồng nào, bổ sung dữ liệu nào và huấn luyện lại cách ra quyết định ra sao.
