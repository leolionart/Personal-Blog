...
Bài toán thật sự là: **Làm sao để AI trở thành một phần đáng tin cậy của hệ thống vận hành**. Mọi câu trả lời của AI đều cần có khả năng kiểm soát, theo dõi và cải tiến liên tục. Mình đã xem demo của nhiều đội sale sản phẩm ở Agentforce, Google Cloud Conversational AI, FPT AI Agents hay các open source Dify, Coze... nhưng vẫn chưa thấy góc nhìn quản lý doanh nghiệp được giải quyết đủ sâu. Khi đào sâu vào chuyện bổ sung kiến thức cho agent và kiểm soát chất lượng từng topic, các sản phẩm này vẫn chưa show được báo cáo hoặc feature đủ rõ để mình tin rằng nó xử lý được bài toán vận hành thật.

Vấn đề là ở thị trường AI lúc này demo thì rất nhiều, public repo trên GitHub được cả nghìn stars cũng không hiếm, nhưng nếu hỏi thật có bao nhiêu sản phẩm đã đi vào vận hành trong business với người dùng thật, quy trình thật, SLA thật và người chịu trách nhiệm thật thì con số đó không nhiều. Demo thường chỉ chứng minh được rằng mô hình "có thể chạy". Production lại đòi hỏi chứng minh rằng hệ thống "có thể sống" trong môi trường doanh nghiệp, chịu được ngoại lệ, audit được, đo được chất lượng và sửa được khi quy trình thay đổi.

Có cảm giác đây là năm thừa agent demo nhưng thiếu agent production. Thừa hào hứng nhưng thiếu humility. Thừa framework nhưng thiếu hiểu biết nền tảng. Người ta rất dễ bị cuốn vào việc dựng một con agent biết gọi tool, biết tự chia bước, biết trả lời trông thông minh, nhưng lại quên hỏi hệ thống phía sau có đủ sạch, đủ ổn định, đủ quan sát được và đủ năng lực hấp thụ thay đổi hay chưa.
...
Vì vậy mình không tin vào mô hình làm AI theo kiểu đóng gói rồi bàn giao xong là đủ. Với phần mềm thông thường chuyện đó đã khó, còn với AI thì gần như không thực tế. Một sản phẩm AI nếu không đi kèm vòng lặp feedback rõ ràng để doanh nghiệp liên tục sửa tri thức, cập nhật quy trình, đánh dấu câu trả lời sai, chuẩn hoá cách xử lý và quan sát chất lượng theo thời gian thì sớm muộn gì cũng lệch khỏi thực tế vận hành.

Nếu bạn đang build agent, có lẽ nên dừng lại hỏi vài câu khó hơn một chút. Mình đang thật sự giải một bài toán có độ mở đủ lớn để cần tới agent, hay chỉ đang gắn nhãn "agent powered" lên một thứ lẽ ra chỉ cần pipeline đơn giản, deterministic và dễ bảo trì hơn? Mình đang để LLM tự chọn cách giải trong một không gian được thiết kế cẩn thận, hay đang vô thức giam LLM trong đúng khuôn tư duy của mình rồi gọi đó là autonomy?
...
Ngay cả khi trao đổi với đội sale của Salesforce, họ cũng phải thừa nhận có những dự án triển khai xong cuối cùng phải đóng lại. Lý do không phải vì model quá tệ, mà vì ở giai đoạn presale ai cũng nghĩ dữ liệu như vậy là đã đủ. Tới lúc chạy thực tế mới lộ ra hàng loạt quy trình phải chỉnh lại cho phù hợp, tài liệu cũ bị outdate gần hết, còn nhiều cách xử lý quan trọng thì trước giờ chỉ nằm trong đầu của vài nhân sự kỳ cựu. Những thứ như vậy gần như không thể nhân rộng nếu không có một hệ thống feedback loop để kéo tri thức ngầm đó ra ngoài, chuẩn hoá dần và phản ánh ngược trở lại vào sản phẩm.

Nhà nhà đang dạy làm AI Chatbot, đưa AI vào toàn bộ quy trình từ chăm sóc khách hàng, phân tích hành vi khách hàng cho tới audit hoạt động vận hành. Nhưng thứ thiếu nhiều nhất có lẽ vẫn là cái nhìn toàn cảnh: làm sao để AI trở thành một phần chạy song song với sự phát triển của doanh nghiệp, cùng lớn lên với quy trình, với dữ liệu, với năng lực quản trị. Chứ không phải coi nó như một dịch vụ SaaS hay một phần mềm setup xong rồi để đấy và hy vọng nó sẽ tự làm tốt phần việc được giao mãi mãi.
...
Vì vậy ngay từ 6 tháng trước là đội mình đã chọn kiến trúc sản phẩm sao cho con người và AI sẽ cùng làm việc với nhau một cách chặt chẽ. AI liên tục học hỏi từ con người để làm tốt hơn, được giao nhiều phần việc hơn, giống quá trình học tập và phát triển của một nhân sự thực thụ. Mỗi lần agent fail là một tín hiệu để đội vận hành biết cần viết lại policy nào, tách lại luồng nào, bổ sung dữ liệu nào và huấn luyện lại cách ra quyết định ra sao.
