...
1. [Output và Outcome khác nhau thế nào](#output-và-outcome-khác-nhau-thế-nào)
2. [Vì sao cần chuyển trọng tâm sang outcome](#vì-sao-cần-chuyển-trọng-tâm-sang-outcome)
3. [Các khái niệm cốt lõi](#các-khái-niệm-cốt-lõi)
4. [Cách đo lường thực tế](#cách-đo-lường-thực-tế)
5. [Checklist hành động](#checklist-hành-động)
...
| Góc nhìn | Output | Outcome |
|---|---|---|
| Bản chất | Việc đã làm | Thay đổi đã tạo ra |
| Ví dụ | Feature đã ship | Retention tăng |
| Ý nghĩa | Theo dõi nỗ lực | Theo dõi tác động |
| Học hỏi | Thấp hơn | Cao hơn |
