...
1. [Tư duy quy hoạch thay vì ghi chép](#-tư-duy-quy-hoạch-thay-vì-ghi-chép)
2. [Phân bổ ví đầu tháng](#-phân-bổ-ví-đầu-tháng)
3. [Chiến lược thẻ tín dụng](#-chiến-lược-thẻ-tín-dụng)
4. [Quy tắc "cạn thì tăng"](#-quy-tắc-cạn-thì-tăng)
5. [Từ phương pháp đến hệ thống](#-từ-phương-pháp-đến-hệ-thống)
...
Hỏi: mình tiêu nhiều hơn vì nhu cầu thật
  ...
  └── Thiếu kiểm soát
        │
        ▼
      Giữ hạn mức, điều chỉnh hành vi
```

Điểm mấu chốt: **hạn mức không phải con số cố định vĩnh viễn**. Nó là công cụ để bạn nhận biết pattern chi tiêu của mình. Khi pattern thay đổi, hạn mức cũng nên thay đổi theo.
