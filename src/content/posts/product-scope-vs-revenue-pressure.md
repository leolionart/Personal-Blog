---
author: leolion
description: Khi PM bị đánh giá chủ yếu qua doanh thu, phạm vi công việc thật sự của
  họ bị bóp méo — và sản phẩm sẽ chịu hậu quả lâu dài.
pubDate: 2023-09-20
tags:
- Product
- Career
title: PM chạy theo doanh thu — tốt hay tệ?
type: post
---
...
1. [Phạm vi công việc PM thực tế là gì?](#phạm-vi-công-việc-pm-thực-tế-là-gì)
2. [Tại sao doanh thu không nên là KPI duy nhất?](#tại-sao-doanh-thu-không-nên-là-kpi-duy-nhất)
3. [Những trade-off nguy hiểm khi PM chạy theo doanh thu](#những-trade-off-nguy-hiểm-khi-pm-chạy-theo-doanh-thu)
4. [Doanh nghiệp nào dễ rơi vào bẫy này?](#doanh-nghiệp-nào-dễ-rơi-vào-bẫy-này)
5. [Hướng ra: Cách cân bằng accountability và product health](#hướng-ra-cách-cân-bằng-accountability-và-product-health)
...
|---|---|
| **Discovery** | User research, xác định vấn đề, validate giả thuyết |
| **Prioritization** | Chọn feature nào làm trước, dựa trên impact vs effort |
| **Delivery** | Align engineering, track sprint, unblock team |
| **Measurement** | Theo dõi metrics, rút insight sau launch |
| **Strategy** | Kết nối roadmap với business goals dài hạn |
...
| Layer | Ví dụ metric |
|---|---|
| **Business** | Revenue, conversion rate, LTV |
| **Product** | Activation rate, feature adoption, NPS |
| **Process** | Delivery predictability, discovery quality |
